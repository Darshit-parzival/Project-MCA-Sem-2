        ...
        <div className="modal-dialog">
          <div className="modal-content bg-dark">
            <div className="modal-header">
              {!sucmessage && !message && (<h5 className="modal-title" id="exampleModalLabel">
                Add Admin
              </h5>)}
              {sucmessage && !message && (<h5 className="modal-title txt-color-success" id="exampleModalLabel">
                {sucmessage}
              </h5>)}
              {!sucmessage && message && <h5 className="modal-title txt-color" id="exampleModalLabel">
                {message}
              </h5>}
              <button
                type="button"
